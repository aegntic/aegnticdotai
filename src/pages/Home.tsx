                    ...
                    <ScrollReveal delay={500}>
                        <div className="mt-16 md:mt-24 max-w-4xl mx-auto relative">
                            ...
                            <p className="relative text-2xl md:text-4xl text-gray-200 leading-tight font-light">
                                <span className="font-serif italic text-gray-400 pr-2">Redefining</span>
                                the <span className="text-white font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">Autonomous Agentic</span>
                                <span className="font-serif italic text-primary ml-2">Ecosystem</span>
                            </p>

                            <p className="mt-6 text-xs md:text-sm text-primary/60 max-w-lg mx-auto font-mono tracking-wider">
                                [ AE-GNT-IC ]: Autonomous Entity Generation Network & Neural Transfer Intelligence Core.
                            </p>
                        </div>
                    </ScrollReveal>
                    ...
                    <ScrollReveal delay={700}>
                        <div className="mt-12 flex flex-col sm:flex-row gap-8 items-center justify-center">
                            ...
                            <button className="group relative px-10 py-4 overflow-hidden text-gray-500 hover:text-white transition-colors">
                                {/* Animated Borders (Top/Bottom only) */}
                    ...
                    <ScrollReveal>
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
                                Advancing the architecture of <span className="text-primary italic font-serif">synthetic intelligence</span>
                            </h2>
                            ...
                            <div className="flex flex-col gap-6 pt-4">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        <h4 className="text-white font-bold mb-1 uppercase text-xs tracking-widest">Neural Transfer Intelligence Core</h4>
                                        <p className="text-gray-500 text-sm">Efficient data serialization for low-latency agentic communication.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative aspect-video rounded-xl overflow-hidden border border-white/10 group">
                            ...
                            <div className="absolute inset-x-8 bottom-8 z-20">
                                <div className="backdrop-blur-md bg-black/40 border border-white/10 p-6 rounded-lg translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                                    <div className="text-[10px] text-primary uppercase tracking-widest mb-2 font-mono">Latest Artifact</div>
                                    <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Simulation Sandbox-7 Observations</h3>
                                    <p className="text-gray-400 text-xs">A 400-hour study on emergent trade behaviors in autonomous societies.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
